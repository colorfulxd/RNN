...
class Model():
    ...
    def build(self, embedding_file=None):
        ...
        with tf.variable_scope('rnn'):
            ...
            # Your Code here
            ##################
            cells = [tf.nn.rnn_cell.DropoutWrapper(tf.nn.rnn_cell.BasicLSTMCell(self.dim_embedding),
        ...
        with tf.variable_scope('softmax'):
            ...
            with tf.variable_scope('softmax'):
                ...
                W = tf.get_variable('W', [self.dim_embedding, self.num_words],initializer=init_truncated)
